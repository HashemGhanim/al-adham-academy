...
function InputRate(props) {
    ...
    return (
        <div id={"user-own-rate"} onClick={rateCrossClicked} className="fixed display-none h-[110vh] w-full z-[70] top-0 top-[-70px]" style={{backgroundColor:'rgba(0, 0, 0, 0.3)'}}>
            <div className="flex justify-center items-center h-full w-full">
                <div onClick={event=> event.stopPropagation()} className="bg-white border border-slate-200 grid grid-cols-6 xl:grid-cols-9 gap-2 rounded-xl p-2 text-sm">
                    <div onClick={rateCrossClicked} className="col-span-1 p-2 hover:bg-gray-50 flex justify-center items-center cursor-pointer">
                    ...
                    <h1 className="text-center text-slate-200 text-xl font-bold col-span-5 xl:col-span-8">ارسل رأيك</h1>
                    <textarea placeholder="تعليقاتك..."
                              className="bg-slate-100 rtl text-slate-600 h-32 xl:h-52 placeholder:text-slate-600 placeholder:opacity-50 border border-slate-200 col-span-6 xl:col-span-9 resize-none outline-none rounded-lg p-2 duration-300 focus:border-slate-600"></textarea>
                    <button
                    ...
                    <span className="col-span-2 xl:col-span-5"></span>
                    <button
