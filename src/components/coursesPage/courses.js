                ...
                <div className="sm:flex sm:mb-0 items-center mb-3 hidden">
                    <form className="lg:pr-3" action="#" method="GET">
                        <div className="lg:w-64	mt-1 relative">
                            <input type="text" name="filter" className="sm:text-sm text-[#111827] p-2.5 bg-[#f9fafb] border-[#d1d5db] border-[1px] rounded-lg w-full block mb-4" placeholder="ابحث عن المحاضرة .." onChange={handleSearchChange}/>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <table className="table-fixed min-w-full border-collapse border-inherit indent-0 rtl">
                                <thead className="bg-[#f3f4f6] rtl">
                                    <tr className="border-b-[1px] border-[#e5e7eb]">
                                        ...
                                        <th scope="col" className="text-[#6b7280] uppercase font-bold text-xs text-right p-4 rtl">الوقت</th>
                                ...
                                <tbody className="border-b-0">
                                {
                                    rows.filter((row)=>{
                                        ...
                                        <tr className="border-t-[1px] border-[#e5e7eb] bg-white hover:bg-[#f3f4f6]">
                                            ...
                                            <td className="p-4 whitespace-nowrap text-[#111827] font-normal text-base text-right ltr">
                                                {row.time}
                                            </td>
                                            <td className="p-4 whitespace-nowrap">
                                                <Link to={"/courses/" + row.meeting_id} state={{meetingPassword: 'iHD6F0' , lessonName:row.name, meeting_id : row.meeting_id}}  className="text-white font-medium text-sm text-center py-2 px-4 rounded-lg inline-flex items-center transition transition-all duration-300 hover:scale-105 " style={{backgroundColor:colors.secondColor}}>
