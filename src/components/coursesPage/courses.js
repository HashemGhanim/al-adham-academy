                                    ...
                                    rows.filter((row)=>{
                                        ...
                                        <tr className="border-t-[1px] border-[#e5e7eb] bg-white hover:bg-[#f3f4f6]">
                                            ...
                                            <td className="p-4 whitespace-nowrap">
                                                <Link to={"/course/87579928728"} state={{meetingPassword: '4hzS3h' , lessonName:row.name}}  className="text-white font-medium text-sm text-center py-2 px-4 rounded-lg inline-flex items-center transition transition-all duration-300 hover:scale-105 " style={{backgroundColor:colors.secondColor}}>
