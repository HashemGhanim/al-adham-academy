...
function Settings(props) {
    ...
    const [profileImage, setProfileImage] = useState('http://localhost:3000/static/media/9439775.7c4b26366a7f766133a1.jpg');
    ...
    return (
        <div className="w-full h-fit rtl box-border overflow-y-scroll px-4 pt-6 relative">
                <ImageModal openModal={openModal} setOpenModal={setOpenModal} setProfileImage={setProfileImage}/>
                    ...
                    <div className="xl:col-auto rounded-lg col-span-full">
                        <div className="bg-white rounded-lg shadow xl:p-8 sm:p-6 p-4 mb-4">
                            <div className="xl:block block sm:flex">
                                <img src={profileImage} className="h-28 w-28 mb-2 rounded-lg"/>
                                <div className="sm:mr-4 mr-0 xl:mr-0">
                                    ...
                                    <button onClick={()=> setOpenModal(true)} className="font-medium cursor-pointer text-base text-center inline-flex rounded-lg py-2 px-3 text-white transition-all hover:scale-105 duration-300" style={{backgroundColor:colors.secondColor}}>
                                        <svg
